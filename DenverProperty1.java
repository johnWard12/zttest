...
// -----------------------------------------
//
// Source: DenverProperty1.java
// Date  : 28 Jun 2021 20:29:42 ECT
 ...
 * Automatically generated load test program.
 */
public class DenverProperty1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	public static final String prxVersion = "V5.5-Z";
	public static final int    prxCharEncoding = 3;                         // 1 = OS Default, 2 = ISO-8859-1, 3 = UTF-8
	public static final String testDescription = "Test property";
	...
	private static final String EXTERNAL_PARAM_FILE = "DenverProperty1ExtParams.dat";       // input file name for very large parameter values
	 ...
	 */
	public DenverProperty1(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext,int innerLoopCounter, int totalInnerLoopCount, Object httpLogVectorObject) throws Exception
	{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883248L;
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883300L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883342L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0004 = "/static/CCD.PublicAppSkin/1.1.11/css/publicappskin.min.css";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 537, 5);		// Test [4] <- Index 4
		if(replayMode)
		{
			long proxyDataRecordId =1623779883346L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0005 = "/property/Content/Pager.css";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 521, 5);		// Test [5] <- Index 5
		if(replayMode)
		{
			long proxyDataRecordId =1623779883353L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0006 = "/property/Content/themes/redmond/jquery-ui-1.8.16.custom.css";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 34031, 5);		// Test [6] <- Index 6
		if(replayMode)
		{
			long proxyDataRecordId =1623779883355L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0007 = "/property/Content/mats_styles.css";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 11518, 5);		// Test [7] <- Index 7
		if(replayMode)
		{
			long proxyDataRecordId =1623779883357L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0008 = "/property/Content/responsive.css";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 3541, 5);		// Test [8] <- Index 8
		if(replayMode)
		{
			long proxyDataRecordId =1623779883376L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883426L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883427L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883430L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883447L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883490L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883491L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0015 = "/property/Scripts/jquery.tablesorter.js";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 49835, 5);		// Test [15] <- Index 15
		if(replayMode)
		{
			long proxyDataRecordId =1623779883492L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0016 = "/property/Scripts/knockout-2.1.0.debug.js";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 174188, 5);		// Test [16] <- Index 16
		if(replayMode)
		{
			long proxyDataRecordId =1623779883493L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883496L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883533L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883534L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883539L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
	...
	boolean executePage_1_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext,int innerLoopCounter, int totalInnerLoopCount, Object httpLogVectorObject) throws Exception
	{
		...
		String requestFile0021 = "/property/Scripts/knockout.validation.js";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 11729, 5);		// Test [21] <- Index 21
		if(replayMode)
		{
			long proxyDataRecordId =1623779883544L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0022 = "/property/Scripts/moment.js";
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 76001, 5);		// Test [22] <- Index 22
		if(replayMode)
		{
			long proxyDataRecordId =1623779883545L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883573L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883576L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883577L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883581L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883589L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		// --- HTTP REQUEST: Test [28] <- WEB ADMIN Index 37 ---
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883694L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883825L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		// --- HTTP REQUEST: Test [30] <- WEB ADMIN Index 40 ---
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883894L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		// --- HTTP REQUEST: Test [31] <- WEB ADMIN Index 41 ---
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883896L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883930L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883936L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883943L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779883986L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779884025L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		// --- HTTP REQUEST: Test [37] <- WEB ADMIN Index 50 ---
		String requestProt0037 = "https";
		String requestHost0037 = "qa.denvergov.org";
		int    requestPort0037 = 443;
		String requestFile0037 = "/denvermapsservices/FindAutoSuggestResults/" +
				"?callback=jQuery19106381437854886092_1623779883589" +
				"&stem=2" +
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/X-JAVASCRIPT", null, 309, 5);		// Test [37] <- Index 37
		if(replayMode)
		{
			long proxyDataRecordId =1623779888704L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/X-JAVASCRIPT", null, 318, 5);		// Test [38] <- Index 38
		if(replayMode)
		{
			long proxyDataRecordId =1623779889368L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		// verify response: status code = 200, content type = "APPLICATION/X-JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 314
		// content test algorithm: check size +/- 5%, defined content size = 314
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/X-JAVASCRIPT", null, 314, 5);		// Test [39] <- Index 39
		if(replayMode)
		{
			long proxyDataRecordId =1623779890212L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/X-JAVASCRIPT", null, 315, 5);		// Test [40] <- Index 40
		if(replayMode)
		{
			long proxyDataRecordId =1623779890593L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
	...
	boolean executePage_1_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext,int innerLoopCounter, int totalInnerLoopCount, Object httpLogVectorObject) throws Exception
	{
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/X-JAVASCRIPT", null, 128, 5);		// Test [41] <- Index 41
		if(replayMode)
		{
			long proxyDataRecordId =1623779891720L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		String requestFile0042 = "/property/realproperty/search/search/0/" +
		...
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JSON", null, 416, 5);		// Test [42] <- Index 42
		if(replayMode)
		{
			long proxyDataRecordId =1623779893659L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
		...
		// --- HTTP REQUEST: Test [43] <- WEB ADMIN Index 59 ---
		log();
		log("# title: 403 Forbidden");
		...
		if(replayMode)
		{
			long proxyDataRecordId =1623779893665L;
			createReplaySnapShotRecord(threadLoopCounter, proxyDataRecordId, testURL, replaySnapShotsDump);
		}
		if (!urlCallPassed)
		{
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("DenverProperty1", concurrentUsers, ParseArgs.getString(args, "-executionPlan"));
		...
		performanceData.setInfoText("DenverProperty1");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new DenverProperty1());
		...
		if (hasExecutionPlan())
		{
			...
			try
			{
				...
				DenverProperty1 simulatedUser = new DenverProperty1(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
